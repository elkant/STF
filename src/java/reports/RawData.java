...
rw.setHeightInPoints(26);
        ...
        System.out.println("" + "STF_reports_Gen_" + createdOn.trim() + ".xls");
        ...
        response.setHeader("Content-Disposition", "attachment; filename=" + "STF_rpt_from_"+startdate+"_to_"+enddate+"__gen_" + createdOn.trim() + ".xls");
